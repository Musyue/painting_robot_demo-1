...
from waypoints_paths_visualization import *
...
class Renovationrobot_motion():
    ...
    def renovation_robot_simulation_motion_visualization(self,visualization_num,manipulatorbase_targetpose_onecell,manipulatorendeffector_targetpose_onecell):
        "computation of target joints of mobile platform and rodclimbing mechanisam and inverse joints of manipulator" 
        mobileplatform_targetjoints, rodclimbing_robot_targetjoints, aubo_targetjoints=self.renovationrobot_joints_computation_0(manipulatorbase_targetpose_onecell,manipulatorendeffector_targetpose_onecell)
        ...
        visualization_num=self.target_path_visualization(visualization_num,manipulatorendeffector_targetpose_onecell)
        ...
        for i in range(1): # range(len(manipulatorbase_targetpose[0])):
            for j in range(1): # range(len(manipulatorbase_targetpose[0][i][0])):
                for k in range(1): # range(len(manipulatorbase_targetpose[0][i][0][j][0])):
                    ...
                    # print("manipulatorbase_pose=:", manipulatorbase_targetpose_onecell)
                    ...
                    Paintrobot.renovation_robot_simulation_motion_visualization(visualization_num,manipulatorbase_targetpose_onecell,manipulatorendeffector_targetpose_onecell)  
